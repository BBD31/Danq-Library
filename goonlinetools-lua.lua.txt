...
function Library:Window(Config)
    ...
    ResizeDetector.InputBegan:Connect(
        function(Input)
            if Dragging then
                return
            end
    ...
    ResizeDetector.InputEnded:Connect(
        function(Input)
            if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
                Resizing = false
            end
            ...
            if
                Resizing and
                    (Input.UserInputType == Enum.UserInputType.MouseMovement or
                        Input.UserInputType == Enum.UserInputType.Touch)
             then
                Delta = Input.Position - ResizeStart
                NewWidth = math.max(250, ResizeStartSize.X.Offset + Delta.X)
                NewHeight = math.max(150, ResizeStartSize.Y.Offset + Delta.Y)
    ...
    function WindowObject:AddTab(TabData)
        ...
        local function ResizeTab()
            local TextBounds =
                TextService:GetTextSize(TabButton.Text, TabButton.TextSize, TabButton.Font, Vector2.new(1000, 100))
            local Padding = 20
            ...
            ToggleButton.MouseButton1Click:Connect(
                function()
                    ...
                    TweenService:Create(
                        ...
                        TweenInfo.new(0.3, Enum.EasingStyle.Back, Enum.EasingDirection.Out),
                        {
                            BackgroundColor3 = ToggleState and Library.CurrentTheme.ToggleOn or
                                Library.CurrentTheme.ToggleOff,
            ...
            local function RefreshHighlights()
                for I, Btn in ipairs(OptionButtons) do
                    ...
                    if Multi then
                        ...
                        TargetColor =
                            (SelectedSingle == I) and Library.CurrentTheme.Accent or Library.CurrentTheme.ElementBg
                    end
                ...
                local function OpenDropdown()
                    ...
                    RenderConn =
                        ...
                        function()
                            ...
                            local Vp =
                                workspace.CurrentCamera and workspace.CurrentCamera.ViewportSize or
                    ...
                    Blocker.MouseButton1Click:Connect(
                        function()
                            CloseDropdown()
                        end
                    )
        ...
        function TabObject:AddColorPicker(Info)
            ...
            UserInputService.InputChanged:Connect(
                function(I)
                    if
                        I.UserInputType ~= Enum.UserInputType.MouseMovement and
